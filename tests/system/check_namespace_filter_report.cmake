...
execute_process(
  COMMAND
    ...
    --module=namespace --module-filter=a::b --project-name=namespace_fixture
...
if(NOT archscope_result EQUAL 0)
  message(
    FATAL_ERROR
      "archscope namespace filter run failed with ${archscope_result}: "
      "${archscope_error}")
endif()
...
if(NOT actual_output STREQUAL expected_output)
  message(
    FATAL_ERROR
      "Generated namespace filter report did not match expected output.")
endif()
