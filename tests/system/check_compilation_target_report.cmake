...
execute_process(
  COMMAND
    ...
    distance_from_main_sequence --module=compilation_target
    --project-name=compilation_target_fixture "--report=${REPORT_OUTPUT}"
...
if(NOT archscope_result EQUAL 0)
  message(
    FATAL_ERROR
      "archscope compilation target run failed with ${archscope_result}: "
      "${archscope_error}")
endif()
...
if(NOT actual_output STREQUAL expected_output)
  message(
    FATAL_ERROR
      "Generated compilation target report did not match expected output.")
endif()
