...
execute_process(
  COMMAND
    "${ARCHSCOPE_BIN}" "${FIXTURE_DB}" abstractness instability --module=header
    --module-filter=include/domain/../domain/alpha.hpp
    --project-name=header_fixture "--report=${REPORT_OUTPUT}"
...
if(NOT archscope_result EQUAL 0)
  message(
    FATAL_ERROR "archscope header filter run failed with ${archscope_result}: "
                "${archscope_error}")
endif()
...
if(NOT actual_output STREQUAL expected_output)
  message(
    FATAL_ERROR "Generated header filter report did not match expected output."
  )
endif()
